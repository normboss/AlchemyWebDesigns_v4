...
<head>
    ...
    <link href="../css/portfolio3a.css" media="screen" rel="stylesheet" type="text/css">
    ...
    <main>
        ...
        <div class="content">
            ...
            <div id="client1" class="client" onclick="wroughtIronLink()">
                <img src="../images/andy_ladder2.png" alt="">
                <div class="copy">
                     ...
                     rating for their creative<br>
                      redesign of my old site<br>
                       and for increasing<br>
                        my sales!&rdquo;<br>
                    <div class="author">Andy, Owner<br> Scottish Wrought Iron.com</div>
                </div>
            </div>
            <div id="copy1" class="client-copy">
                ...
                <div class="author">Andy, Owner Scottish Wrought Iron.com</div>
            </div>

            <div id="client3" class="client" onclick="sliceOCountry()">
                <img src="../images/SarharWithBackground.png" alt="">
                <div class="copy">
                     ...
                     and eager to support<br>
                      my business as I<br>
                       expand reaching<br>
                        new heights with<br>
                         their support.&rdquo;
                    <div class="author">Sarah, Owner A <br>Slice of Country.com</div>
                </div>
            </div>
            <div id="copy1" class="client-copy">
                &ldquo;Having my own website made a huge difference!&rdquo;
                <div class="author">Sarah, Owner A Slice of Country</div>
            </div>

            <div id="client2" class="client" onclick="elementalShift()">
                <img src="../images/Kirsten_left1@2x.png" alt="">
                <div class="copy">
                    ...
                    <div class="author">Kirsten, Owner<br> Elemental Shift.com</div>
                </div>
            </div>
            <div id="copy1" class="client-copy">
                &ldquo;I needed a website to connect with my target audience.
                Alchemy worked hard to make that happen.&rdquo;
                <div class="author">Kirsten, Owner Elemental Shift</div>
            </div>

            <div id="client4" class="client" onclick="maineVillageWeaver()">
                <img src="../images/PhyllisSmiling.png" alt="">
                <div class="copy">
                    &ldquo;Weaving is my passion. It’s wonderful<br>
                     to share it with so many folks on my<br>
                      new website.&rdquo;
            ...
            <div id="copy1" class="client-copy">
                ...
                <div class="author">Phyllis, Owner Maine Village Weaver.com</div>
            </div>
